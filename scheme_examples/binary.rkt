;; Binary tree implementation using structs
;; does some rudimentary struct operations and tree searches
...
(compute (parse '(1 + 2 + 3 + 4)))

;; Inspect the tree given from this parsing
;; The default is to pretty print the data structure
(parse '(4 + 3 * 7 - 5 / (3 + 4) + 6))
