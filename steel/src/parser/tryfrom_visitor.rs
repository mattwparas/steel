...
use super::{ast::Atom, visitors::ConsumingVisitor};
...
impl ConsumingVisitor for SyntaxObjectFromExprKind {
    ...
    fn visit_if(&mut self, f: Box<super::ast::If>) -> Self::Output {
        ...
        Ok(Syntax::new(SteelVal::ListV(expr.into_iter().collect()), span).into())
    }
    ...
    fn visit_begin(&mut self, begin: super::ast::Begin) -> Self::Output {
        ...
        Ok(Syntax::new(SteelVal::ListV(exprs.into()), span).into())
    }
    ...
    fn visit_atom(&mut self, a: Atom) -> Self::Output {
        ...
        Ok(Syntax::new(SteelVal::try_from(a.syn)?, span).into())
    }
