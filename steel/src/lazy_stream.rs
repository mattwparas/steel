...
impl<'global, CT: ConstantTable> Iterator for LazyStreamIter<'global, CT> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let next_value = exec_func(stream_thunk, self.constants, self.cur_inst_span, self.repl);
