...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  (define (rewrite-with-lemmas term lst)
    ...
    (cond ((null? lst)
           term)
          ((one-way-unify term (dbg! (cadr (car lst)))) ;; HERE IS THE CHANGE
  ...
  (define (one-way-unify1 term1 term2)
         ...
         (error #f)
          ...
          ; (when (list? term2) (displayln term2))
          ; (displayln "---------------------------------------------")
